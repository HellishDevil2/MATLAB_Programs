...
baseband_with_noise = lowpass(baseband_with_noise,100*message_frequency,sampling_frequency);
...
baseband_without_noise = lowpass(baseband_without_noise,100*message_frequency,sampling_frequency);
